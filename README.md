...
> **My default loop:** read the source → trace the runtime → reproduce the failure → fix the owner → verify the result.

## The workbench

| I build | I chase | I automate |
|:---|:---|:---|
| Agentic AI and backend systems that stay understandable after the demo | Failures across prompts, services, queues, storage, and observability | Repeated friction—reviews, checks, workflows, and anything that takes three clicks twice |

Recent work includes taking **GPT-5.6 Luna** through production rollout, leading a **three-developer AI Pod**, and co-leading reliability work that reduced Langfuse/ClickHouse disk usage from **175 GiB to 12 GiB**.

Before the AI Pod, I worked in Habuild's CRM engineering pod on high-throughput messaging and failure recovery. Earlier, I led backend delivery for credit-card acquisition at **Freecharge** and built catalog, payment, order, onboarding, and chatbot systems at **BYJU'S**.

## The person behind the terminal

- Linux and macOS windows must tile. Dragging them manually feels like packet loss.
- Long documentation becomes text-to-speech; walks become architecture reviews.
...
<p align="center">
  <strong>Build by hand. Accelerate with AI. Verify everything.</strong><br />
  <sub>If production disagrees, production wins the argument.</sub>
</p>
